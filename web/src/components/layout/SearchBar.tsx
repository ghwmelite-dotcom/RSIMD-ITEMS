...
export function SearchBar() {
  ...
  return (
    <div ref={containerRef} className="relative hidden sm:block">
      ...
      {isOpen && hasResults && (
        <div className="absolute top-full mt-1 w-80 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg z-50 max-h-80 overflow-y-auto">
          {results.equipment.length > 0 && (
            <div>
