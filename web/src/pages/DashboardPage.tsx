      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        ...
        <div className="flex items-center gap-3">
          <a
            ...
            target="_blank"
            className="inline-flex items-center gap-1.5 px-3 py-1.5 text-[10px] font-mono font-semibold uppercase tracking-wider text-surface-400 hover:text-neon-green border border-surface-700/50 hover:border-neon-green/30 rounded-lg transition-all"
          >
